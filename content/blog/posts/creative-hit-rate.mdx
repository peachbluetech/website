...
Repeat monthly on the same rules and you also get the trend, which is worth more than the level. The verdicts themselves come from upstream: [the creative testing framework](/blog/creative-testing-framework) is the written system that produces them, and a drifting framework makes this measurement meaningless.
