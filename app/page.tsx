        ...
        <div className="max-w-[560px] mx-auto relative text-center">
          ...
          <div className="rounded-2xl border border-pb-border bg-pb-card/80 backdrop-blur-sm p-7 shadow-pb-soft text-left">
            ...
            <p className="text-[13.5px] text-pb-fg-muted leading-relaxed mb-5 text-center">
              Leave your email and we&apos;ll set up a guided demo of Peachblue on your own ad data.
            </p>
            {submitted ? (
              ...
              <form onSubmit={(e) => {
                ...
                <input type="email" required value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@company.com" className="flex-1 min-w-0 h-12 rounded-full border border-pb-border bg-pb-card px-5 text-[14px] placeholder:text-pb-fg-muted focus:outline-none focus:border-pb-peach-400 focus:ring-2 focus:ring-pb-peach-100 shadow-pb-soft" />
                <button type="submit" className="inline-flex items-center gap-2 h-12 px-6 rounded-full border border-pb-border bg-pb-bg text-[14px] font-semibold text-pb-fg shadow-pb-soft hover:shadow-pb-lift transition shrink-0">
                  Book a demo &rarr;
                </button>
              </form>
            )}
